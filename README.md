...
=======
Live on **Polygon Mainnet** (chainId 137). 218 unit tests passing, full end-to-end mainnet verification. Core contracts deployed deterministically via CreateX to `0xdeed…` vanity addresses, owner-controlled. Source verification on PolygonScan + Sourcify is in progress.

<details><summary>▶ 한국어로 보기</summary>

**Polygon 메인넷**(chainId 137)에 라이브. 단위 테스트 218건 통과, 메인넷 end-to-end 검증 완료. 코어 컨트랙트는 CreateX로 `0xdeed…` 베니티 주소에 결정론적으로 배포되었으며 owner가 제어합니다. PolygonScan + Sourcify 소스 검증은 진행 중입니다.
>>>>>>> 22b51264050be1504cb3620c6bd7759564dd0158
